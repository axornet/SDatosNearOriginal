Public Class frmImportBizPhoenix
    ...
    Private Sub cmdStartCancelExit_Click(sender As System.Object, e As System.EventArgs) Handles cmdStartCancelExit.Click
        Select Case cmdStartCancelExit.Text
            Case "Start"
                If MsgBox("Do you whant to import BIZ Phoenix's Data?", vbYesNo Or vbQuestion) = vbYes Then
    ...
    Private Sub lp_ImportData()
        Me.txtResultado.Text = cImportPhoenixGeneric.Import("[BIZPHOENIX]", Me.pgbGlobal, Me.pgbCurrent, Me.lblCurrentOp, Me.lblTable, GC_BizSystem)
