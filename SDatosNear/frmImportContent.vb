Public Class frmImportContent
    ...
    Private Sub cmdStartCancelExit_Click(sender As System.Object, e As System.EventArgs) Handles cmdStartCancelExit.Click
        Select Case cmdStartCancelExit.Text
            Case "Start"
                If MsgBox("Do you whant to import Content's Data?", vbYesNo Or vbQuestion) = vbYes Then
    ...
    Private Sub lp_ImportData()
        Me.txtResultado.Text = cImportContentGeneric.Import("[CONTENT]", Me.pgbGlobal, Me.pgbCurrent, Me.lblTable, Me.lblCurrentOp, GC_EduSystem)
